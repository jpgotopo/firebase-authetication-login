...
import 'package:gpm_version_4/src/ui/medicine_details/medicine_details.dart';
import 'package:gpm_version_4/src/ui/new_entry/new_entry.dart';
...
class MedicineCard extends StatelessWidget {
  ...
  Hero makeIcon(double size) {
    ...
    } else if (medicine.medicineType == "Ofrendar") {
      return Hero(
        tag: medicine.medicineName + medicine.medicineType,
        child: Icon(
    ...
    } else if (medicine.medicineType == "Movilizar") {
      return Hero(
        tag: medicine.medicineName + medicine.medicineType,
        child: Icon(
    ...
    } else if (medicine.medicineType == "Ir") {
      return Hero(
        tag: medicine.medicineName + medicine.medicineType,
        child: Icon(

...
import 'package:gpm_version_4/src/models/errors.dart';
import 'package:gpm_version_4/src/models/medicine.dart';
import 'package:gpm_version_4/src/models/medicine_type.dart';
...
class _NewEntryState extends State<NewEntry> {
                ...
                child: StreamBuilder<MedicineType>(
                  ...
                  builder: (context, snapshot) {
                    return Row(
                      ...
                      children: <Widget>[
                        MedicineTypeColumn(
                            type: MedicineType.Orar,
                            name: "Orar",
                            iconValue: 0xe900,
                            isSelected: snapshot.data == MedicineType.Orar
                                ? true
                                : false),
                        MedicineTypeColumn(
                            type: MedicineType.Ofrendar,
                            name: "Pill",
                            iconValue: 0xe901,
                            isSelected: snapshot.data == MedicineType.Ofrendar
                                ? true
                                : false),
                        MedicineTypeColumn(
                            type: MedicineType.Movilizar,
                            name: "Syringe",
                            iconValue: 0xe902,
                            isSelected: snapshot.data == MedicineType.Movilizar
                                ? true
                                : false),
                        MedicineTypeColumn(
                            type: MedicineType.Ir,
                            name: "Tablet",
                            iconValue: 0xe903,
                            isSelected: snapshot.data == MedicineType.Ir
                                ? true
                                : false),
                      ],
                    );
  ...
  Future onSelectNotification(String payload) async {
    ...
    await Navigator.push(
      context,
      new MaterialPageRoute(builder: (context) => CalendarPage()),
    );
  }
